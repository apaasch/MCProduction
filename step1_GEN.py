...
# with command line options: Configuration/GenProduction/python/HIG-RunIISummer20UL17wmLHEGEN-00209-fragment.py --python_filename HIG-RunIISummer20UL17wmLHEGEN-00209_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(<RANDOMSEED>) --datatier GEN,LHE --fileout file:HIG-RunIISummer20UL17wmLHEGEN-00209.root --conditions 106X_mc2017_realistic_v9 --beamspot Realistic25ns13TeVEarly2017Collision --step LHE,GEN --geometry DB:Extended --era Run2_2017 --no_exec --mc -n <NEVENTS>
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIISummer20UL17wmLHEGEN-00209-fragment.py nevts:<NEVENTS>'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer20UL17wmLHEGEN-00209.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer20UL17wmLHEGEN-00209_inLHE.root'),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(<RANDOMSEED>)
